...
contract TSwapPool is ERC20 {
    ...
    function deposit(
        ...
        //@written-high this deadline parameter is not used
        uint64 deadline
    )
        external
        ...
        returns (uint256 outputAmount)
    {
        ...
        // @audit-info magic number should be defined as constants
    ...
    {
        //@audit-info magic number constant
        //@audit-high 91.3% fees ?
        //Users are charged too much
    ...
    function sellPoolTokens(uint256 poolTokenAmount) external returns (uint256 wethAmount) {
        // @audit this is wrong
        // poolTokenAmount should be amount of weth
